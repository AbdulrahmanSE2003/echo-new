      ...
      {isLoading ? (
        ...
        <div className="p-4 max-w-6xl mx-auto pb-10">
          ...
          <div className="flex justify-between items-center mb-6 py-2">
            <div className="flex flex-wrap ml-5 justify-center items-center gap-4">
            ...
            <div className="w-3/6 flex justify-end">
              <input
                ...
                className="search-products w-full max-w-md bg-white border border-gray-300 focus:border-green-700 focus:ring-1 focus:ring-green-600 outline-none px-4 py-2 rounded-full shadow-sm transition duration-300 "
              />
            </div>
          </div>
